...
control_configurations = [
    basic.ControllerConfig(name_pattern=".*",
                           ...
                           scale_z=False,
                           priority=100),
    basic.ControllerConfig(name_pattern="global_CTRL", control_scale=3, color=(1, 1, 0)),
    basic.ControllerConfig(name_pattern="world_offset_CTRL", control_scale=2.5, color=(1, 0.486, 0)),
    basic.ControllerConfig(name_pattern="cog_CTRL", color=(1, 0.966, 0.608)),
